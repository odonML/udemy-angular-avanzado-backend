...
const controller = require("../controllers/usuarios.controller"); //Funciones para Peticiones
...
router.get(
  ...
  controller.getUsuarios //Funcion para Obtener los Usuarios
);
// -------------------------------------------------------------
...
router.post(
  ...
  controller.crearUsaurio //Funcion para Crear los Usuarios
);
// --------------------------------------------------------------
...
router.put(
  ...
  controller.actualizarUsuario //Funcion para Actualizar usuario
);
// --------------------------------------------------------------
...
router.delete(
  "/:id",
  [validarJWT], //Middleware para la validacion de token
  controller.eliminarUsuario //Funcion para Eliminar usuario
  );
